...
class Google_Service_AdExchangeBuyerII_Resource_AccountsProposals extends Google_Service_Resource
{
   ...
   * `lead_id`, the server will assign a new unique ID and create the deal. If
   * passed-in deal has a `lead_id`, it will be updated to match the passed-in
   * copy. Any existing deals not present in the passed-in proposal will be
   * deleted. It is an error to pass in a deal with a `lead_id` not present at
