                ...
                if (($this->rbac->hasPrivilege('student', 'can_view') ||
                   ...
                   <li class="treeview <?php echo set_Topmenu('Lead Information'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php
                            if ($this->rbac->hasPrivilege('student', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('lead/search'); ?>"><a href="<?php echo base_url(); ?>lead/search"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('lead_details'); ?></a></li>
                            <?php }
