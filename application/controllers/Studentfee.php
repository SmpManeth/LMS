...

{
...

    {
        ...
        $student              = $this->student_model->get($id)[0];
        ...
        $class_section                = $this->student_model->getClassSection($student['ielts_course']);

        $data["class_section"]        = $class_section;

        $session                      = $this->setting_model->getCurrentSession();

        $studentlistbysection         = $this->student_model->getStudentClassSection($student["ielts_course"], $session);
