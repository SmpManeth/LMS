...

{
...

    {
        ...
        $this->db->select('staff_rating.rate,staff_rating.comment,staff_rating.role,students.first_name as firstname students.last_name as lastname')->from('staff_rating')->join("users", "users.id = staff_rating.user_id", "inner")->join("staff", "staff_rating.staff_id = staff.id", "inner")->join("students", "students.id = staff_rating.user_id", "left");
